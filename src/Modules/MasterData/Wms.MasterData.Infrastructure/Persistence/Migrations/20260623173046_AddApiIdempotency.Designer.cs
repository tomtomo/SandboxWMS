...
namespace Wms.MasterData.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260623173046_AddApiIdempotency")]
    partial class AddApiIdempotency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wms.BuildingBlocks.Application.Idempotency.ApiIdempotencyRecord", b =>
                {
                    ...
                    b.HasKey("Endpoint", "IdempotencyKey")
                        .HasName("pk_api_idempotency");

                    b.HasIndex("RecordedAt")
                        .HasDatabaseName("ix_api_idempotency_recorded_at");

                    b.ToTable("api_idempotency", "infrastructure");
                });
