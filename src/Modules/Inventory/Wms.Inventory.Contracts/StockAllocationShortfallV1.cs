...
// menandai OrderLine Short/Backordered; Notification meng-alert. Hanya line yang KURANG yang dibawa (line
// penuh lewat StockAllocated). Nama "Shortfall" (selisih kurang) — AKURAT untuk nol DAN parsial; sengaja
// BUKAN "Failed" (terkesan total) atau "Partial" (mengecualikan line yang dapat 0). Selaras vocab
// OrderLine.AllocationStatus.Short + ShortQty.
...
public sealed record StockAllocationShortfallV1(
    Guid WaveId,
    IReadOnlyList<StockAllocationShortfallLineV1> Lines)
{
    public const string LogicalName = "inventory.stock_allocation_shortfall.v1";
}
...
public sealed record StockAllocationShortfallLineV1(
