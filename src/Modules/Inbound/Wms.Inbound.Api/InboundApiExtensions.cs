...
// Why: host cukup app.MapInboundEndpoints() — semua slice REST terdaftar di satu tempat
// (bukan controller terpusat). Tambah slice = tambah satu IEndpoint + satu baris di sini.
